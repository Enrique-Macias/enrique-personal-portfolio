    ...
    <section id="contact" className="px-6 py-24 sm:py-32">
      <div className="mx-auto max-w-6xl">
        <SectionHeading
          ...
          kicker="I'm open to internships, collaborations, and interesting problems."
        />
        <div className="grid gap-10 md:grid-cols-2">
          <RevealOnScroll>
            <div className="space-y-4">
              <ContactLink href={`mailto:${profile.email}`} icon={Mail} label={profile.email} />
              <ContactLink href={profile.github} icon={Github} label="github.com/enriquemacias" />
              <ContactLink href={profile.linkedin} icon={Linkedin} label="linkedin.com/in/enriquemacias" />
            </div>
          </RevealOnScroll>
            ...
            >
              ...
              {status.kind === "ok" && (
                ...
                >
                  ...
                  <span>Thanks — message received. I'll reply soon.</span>
                </div>
              )}
              {status.kind === "err" && (
                <div
